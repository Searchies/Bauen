...
public class GoldHoardBlock extends Block {

    public static final MapCodec<GoldHoardBlock> CODEC = GoldHoardBlock.createCodec(GoldHoardBlock::new);
    ...
    public MapCodec<GoldHoardBlock> getCodec() {
        return CODEC;
    }

    public GoldHoardBlock(AbstractBlock.Settings settings) {
        super(settings);
